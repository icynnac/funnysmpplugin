        ...
        if (sender instanceof Player) {
            ...
            if (args.length > 0) {
                ...
                switch (args[0].toLowerCase()) {
                    case "guides":
                        p.sendMessage("§8§lGuides: §bhttps://github.com/icynnac/funnysmpplugin/wiki");
                    case "commands":
                        if (args.length > 1) {
                            switch (args[1].toLowerCase()) {
                                case "1":
                                    ...
                                    sendInteractiveMessage(p, "§e/boop §8- §d§lBoop!", "/boop (player)", ClickEvent.Action.SUGGEST_COMMAND, "Click to use /boop");
                                    ...
                                    sendInteractiveMessage(p, "§e/createhome §8- §6Create a /home", "/createhome (name of home)", ClickEvent.Action.SUGGEST_COMMAND, "Click to use /createhome");
                                    ...
                                    sendInteractiveMessage(p, "§e/heart §8- §c❤", "/heart", ClickEvent.Action.SUGGEST_COMMAND, "Click to use /heart");
                                ...
                                case "2":
                                    ...
                                    break;
                                case "3":
                                    next.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/help commands 4"));
                                    previous.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/help commands 2"));
                                    p.sendMessage("§6-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-");
                                    sendInteractiveMessage(p, "§e/sethome §8- §6like /createhome, but shorter", "/sethome (home name)", ClickEvent.Action.SUGGEST_COMMAND, "Click to use /sethome");
                                    ...
                                    break;
                                case "4":
                                    previous.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/help commands 3"));
                                    p.sendMessage("§6-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-");
                ...
                sendInteractiveMessage(p, "§c§lGuides", "https://github.com/icynnac/funnysmpplugin/wiki", ClickEvent.Action.OPEN_URL, "§fClick to open the guides.");
                p.sendMessage("§6-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-");
            }
        }
        return false;
